...
export const ROLES: Role[] = [
  {
    title: "Next.js 16 & Fullstack Builder",
    type: "Sprint Contract / Project · Work From Home",
    openings: 2,
    description: "Build high-speed client web apps and SaaS frontends in Next.js 16, React 19, and Tailwind CSS v4. Ship live production code in 7-day sprints with clean component architecture.",
    requirements: ["Next.js App Router & Server Components proficiency", "Tailwind CSS & responsive layout mastery", "Clean TypeScript code hygiene", "Ability to deliver on 7-day sprint timelines", "Own laptop & stable setup"],
    expect: ["Deliver pixel-perfect responsive layouts matching design tokens", "Zero-layout-shift and 90+ PageSpeed audits", "Communicate blockers early on WhatsApp", "Clean git commits and PR documentation", "Fast turnaround on client revisions"],
    perks: ["Direct credit in client case studies and code repo", "Access to our studio component library & boilerplates", "High per-project sprint payouts (no delay)", "Direct mentorship on AI integration from founder", "Path to full-time engineering core"],
    slug: "developer",
    status: "Open",
  },
  {
  ...
  {
    title: "Growth & Business Development Partner",
    type: "High Commission + Rev-Share · Work From Home",
    openings: 2,
    description: "Connect with clinics, healthcare founders, luxury realtors, and SaaS startups. Pitch Next Scale's 7-day websites and WhatsApp AI receptionists and close deals.",
    requirements: ["Strong consultative communication in English & Hindi", "Understanding of modern web & AI value propositions", "Comfortable with WhatsApp outreach, phone calls, and demos", "Self-driven deal closer — zero micro-management needed", "Based in India or UAE/Gulf region"],
    expect: ["Conduct 10+ high-quality targeted outreaches daily", "Follow up systematically with warm leads", "Maintain clean pipeline in our simple deal sheet", "Coordinate seamlessly with engineering for client handoff", "Represent Next Scale professionally with zero false promises"],
    perks: ["High uncapped commission per deal (₹10,000–₹35,000+ / deal)", "Monthly recurring revenue share on retained client retainers", "Full sales collateral, video demos, and deck access", "Top closer perks and fast promotion to Head of Growth", "Complete location independence"],
    slug: "sales_rep",
    status: "Open",
  },
  {
    title: "Short-Form Video & Motion Creative",
    type: "Per-Deliverable Retainer · Work From Home",
    openings: 1,
    description: "Craft high-retention short-form video breakdowns, product launch reels, and kinetic neo-brutalist animations showcasing our AI systems and client results.",
    requirements: ["Proficient in Premiere Pro, DaVinci Resolve, or After Effects", "Mastery of fast pacing, kinetic captions, sound design, and hooks", "Portfolio of high-retention tech / startup reels or shorts", "24–48h turnaround time on assigned edits", "Creative independence with minimal supervision"],
    expect: ["Edit 3–4 high-impact short-form videos weekly", "Design eye-catching custom thumbnails and motion overlays", "Align visuals with Next Scale's bold neo-brutalist aesthetic", "Iterate on hook retention metrics and engagement data", "Deliver clean exports formatted for Instagram, YouTube, and X"],
    perks: ["Steady monthly retainer with reliable payout schedule", "Massive reach on videos seen by tens of thousands of founders", "Creative freedom to experiment with new video formats", "Direct collaboration with founder on content strategy", "Build an elite tech-focused motion design reel"],
    slug: "video_editor",
    status: "Open",
  },
  {
    title: "Prompt Engineer & LLM Evaluator",
    type: "Part-Time / Internship · Work From Home",
    openings: 1,
    description: "Red-team and evaluate our autonomous WhatsApp receptionists. Craft adversarial prompts, benchmark appointment booking accuracy, and refine system instructions.",
    requirements: ["Deep curiosity for LLM behavior and prompt design", "Analytical eye for nuanced language and tone consistency", "Basic Python or JSON data evaluation skills", "Proactive problem solver with attention to detail", "College students / freshers welcome to apply"],
    expect: ["Run automated and manual stress tests across 50+ conversation scenarios", "Document failure modes and hallucination edge cases", "Iterate on system prompts to achieve 99%+ booking precision", "Maintain benchmark test logs in Supabase", "Participate in weekly model evaluation reviews"],
    perks: ["Paid internship with hands-on enterprise AI training", "Letter of recommendation & certificate from Next Scale Labs", "Fast track to junior AI engineer upon graduation", "Mentorship directly from lead architects", "Flexible hours fitting college schedules"],
    slug: "prompt_evaluator",
    status: "Open",
  },
];
