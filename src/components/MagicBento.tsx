...
const DEFAULT_GLOW_COLOR = '39, 208, 237'; // Nextscale Cyan
...
interface MagicBentoProps {
  cardDataList?: Array<{ color: string; title: string; description: string; label: string }>;
...
const MagicBento = ({
  ...
  const displayCards = cardDataList || [
    {
      color: '#0d1016',
      title: 'Analytics',
