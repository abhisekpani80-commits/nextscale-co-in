...
const STEPS: StepData[] = [
  ...
  },
  {
    ...
    day: "DAYS 04–05",
    dayLabel: "DAY 05",
    title: "Build & Concierge Setup",
    description:
      "We build your custom high-converting storefront and configure your 24/7 WhatsApp concierge with your services, pricing, and calendar.",
    icon: MessageSquare,
    points: [
      "Instant-loading storefront",
      "24/7 WhatsApp concierge setup",
